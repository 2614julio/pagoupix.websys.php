...
<?php
  ...
  if(isset($_GET['secret'])){
        ...
        if($client_info){
           ...
           $client->updateSecret($client_info->id,md5(uniqid()));
           $step=2;
                ...
                <div class="col-md-4">
                    <div class="card" >
                      <div class="card-body">
                        ...
                        <input type="hidden" id="account" value="<?= $client_info->token; ?>" />
                        <div class="form-group">
                          <input type="password" placeholder="Senha" id="senha1" class="form-control" name="" value="">
                        </div>
                        <div class="form-group">
                          <input type="password" placeholder="Repetir senha" id="senha2" class="form-control" name="" value="">
                        </div>
                        <div class="form-group">
