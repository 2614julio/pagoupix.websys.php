...
<body>
    ...
    <div class="container position-relative">
      <div class="row gy-5" data-aos="fade-in">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
          ...
          <p id="hero">Automático, profissional e sem burocracia. Descomplique suas cobranças e fature mais.</p>
         <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="panel/create" class="btn-get-started">Comece gratis</a>
           <!--  <a href="https://www.youtube.com/watch?v=" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Ver Video</span></a>  -->
          </div>
        </div>
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
		  ...
		  <h2>Recebimento Direto</h2>
            <p>Com o <?= parse_url(SITE_URL, PHP_URL_HOST); ?>, você emite notificações com link de cobrança e recebe o pagamento diretamente em sua conta, sem intermediações e taxas.</p>
          </div>
          <ul>
      ...
      <div class="container" data-aos="zoom-out">
        ...
        <div class="clients-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="panel/assets/img/gateways/pagbank.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="panel/assets/img/gateways/picpay.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="panel/assets/img/gateways/paghiper.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="panel/assets/img/gateways/asaas.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="panel/assets/img/gateways/mercadopago.png" class="img-fluid" alt=""></div>
        <!-- <div class="swiper-slide"><img src="panel/assets/img/gateways/cronjob.png" class="img-fluid" alt=""></div> -->
          </div><br><br><br>
        </div>
        <div class="row">
            ...
            <div class="col-md-4 col-12 col-lg-4 col-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>
                            <button style="width: 100%;background-color: #f85a40;border: #f85a40;" class="btn btn-lg btn-success" onclick="location.href='<?= SITE_URL; ?>/panel/create';">Continuar grátis</button>
                        </p>
    ...
    <!-- ======= Hero2 Section ======= --><!-- End Hero2 Section -->
  <!-- Partners -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="content px-xl-5">
              ...
              <p>
                Tire suas dúvidas através das perguntas respondidas.
              </p>
            </div>
          </div>
            ...
            <div class="accordion accordion-flush" id="faqlist" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="accordion-item">
                ...
                <div id="faq-content-3" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Sim! Nós estamos trabalhando com a última versão do whatsapp, então você pode se conectar em nosso site e mesmo assim usar o whatsapp web.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item">
                ...
                <div id="faq-content-4" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Mesmo sem bateria ou internet nosso site vai cobrar seu cliente usando seu whatsapp, pois seu whatsapp fica conectado em nosso servidor 24hr por dia.
                  </div>
                </div>
              </div><!-- # Faq item-->
  ...
  <footer id="footer" class="footer">
      ...
      <div class="row gy-4">
        <div class="col-lg-6 col-md-12 footer-info">
          ...
          <p style="color: #111B25">
           Sistema de cobranças automáticas com envio pelo WhatsApp e integração com métodos de pagamento da sua escolha.
          </p>
          <div style="color: #111B25" class="social-links d-flex mt-4">
            <a href="https://instagram.com/<?= parse_url(SITE_URL, PHP_URL_HOST); ?>" class="instagram"><i class="bi bi-instagram"></i></a>
          </div>
        </div>
    ...
    <div class="container mt-4">
      <div style="color: #111B25" class="copyright">
        &copy; Copyright <strong><span><?= parse_url(SITE_URL, PHP_URL_HOST); ?></span></strong> Todos os direitos reservados! 2023.
      </div>
    </div>
