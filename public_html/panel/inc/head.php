 ...
 <style>
     <?php
          ...
          if(SIDEBAR_COR != 'blue' && SIDEBAR_COR != 'green' && SIDEBAR_COR != 'orange' && SIDEBAR_COR != 'red' && SIDEBAR_COR != 'yellow'){
              echo '.sidebar[data-color="custom"]:after, .off-canvas-sidebar[data-color="green"]:after{ background: '.SIDEBAR_COR.'; }';
              $cor_sidebar   = 'data-color="custom"';
              $style_name_s  = 'custom';
          }
          
          if(SIDEBAR_OPC_COR != "#FFFFFF"){
              echo '.sidebar .nav li.active>a, .off-canvas-sidebar .nav li.active>a{background-color: '.SIDEBAR_OPC_COR.'!important;}';
          }
