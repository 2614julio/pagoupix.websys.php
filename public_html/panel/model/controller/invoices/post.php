...
$columns = array(
    ...
    array( 'db' => 'id', 'dt' => 'opc' , 'formatter' => function ($d, $row) {
      ...
      $sql   = $pdo->query("SELECT ref FROM invoices WHERE id='".$row['id']."'");
      $fat   = $sql->fetch(PDO::FETCH_OBJ);
       ...
       $var_html = "<div class=\"dropdown\">
            ...
            <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\">
              ...
              <a onclick=\"delete_invoice(".$row['id'].");\" class=\"dropdown-item\" style=\"cursor:pointer;\" ><i class=\"fa fa-trash\" ></i> Remover  </a>
